...
import { type TimeRemaining } from "@/lib/launch-countdown";

type MarketingPageProps = {
    initialTimeRemaining: TimeRemaining;
};

export function MarketingPage({ initialTimeRemaining }: MarketingPageProps) {
    return (
        <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
            ...
            <LaunchCountdownModal initialTimeRemaining={initialTimeRemaining} />
            <SiteHeader />
            <main>
                <HeroSection />
                <ValueSection />
