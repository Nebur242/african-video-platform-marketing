...
export function HeroSection() {
    ...
    return (
        <section id="top" className="relative overflow-hidden">
            ...
            <div className="absolute right-[-8rem] top-20 h-56 w-56 rounded-full bg-[radial-gradient(circle,rgba(255,208,160,0.3),transparent_68%)] blur-3xl sm:top-32 sm:h-72 sm:w-72" />
            <div className="mx-auto grid max-w-7xl gap-10 px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-14 lg:px-8 lg:pb-28 lg:pt-20">
                <Reveal className="space-y-6 sm:space-y-8">
                    <span className="inline-flex max-w-full items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-xs text-primary sm:text-sm">
                        <Sparkles className="size-4" />
                        <span className="truncate sm:whitespace-normal">{content.hero.eyebrow}</span>
                    </span>
                    <div className="space-y-5 sm:space-y-6">
                        <h1 className="max-w-4xl text-balance font-display text-4xl leading-[0.95] sm:text-6xl lg:text-7xl">
                            {content.hero.title}
                        </h1>
                    ...
                    <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
                        {content.hero.stats.map((stat) => (
                            <div
                                key={stat.label}
                                className="rounded-3xl border border-border/70 bg-card/70 p-4 backdrop-blur sm:p-5"
                            >
                ...
                <Reveal delay={120} className="relative">
                    <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(160deg,rgba(16,16,16,0.88),rgba(36,16,14,0.96))] p-4 text-white shadow-[0_30px_120px_rgba(14,14,14,0.45)] sm:p-6 dark:border-white/15">
                        ...
                        <div className="relative space-y-4 sm:space-y-6">
                            <div className="flex items-start justify-between gap-4 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm sm:items-center">
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-2 font-display text-xl sm:text-2xl">African Video Platform</p>
                                </div>
