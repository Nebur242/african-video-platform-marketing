...
export function DiscoverySection() {
  ...
  return (
    <section id="discovery" className="mx-auto max-w-7xl px-5 py-20 sm:px-6 lg:px-8 lg:py-28">
      <Reveal>
        <SectionTitle
        ...
        {content.discovery.columns.map((column, index) => {
          ...
          return (
            <Reveal key={column.title} delay={index * 110}>
              <article className="rounded-[2rem] border border-border/70 bg-card/70 p-6 backdrop-blur">
